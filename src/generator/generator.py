...
all_registers = {
    ...
    'k0': 0, 'k1': 0,
    'gp': 0, 'sp': 0, 'fp': 0, 'ra': 0,
    'f4': 0, 'f6': 0, 'f8': 0, 'f10': 0, 'f16': 0, 'f18': 0, 'lbl1': 0
}

float_registers = {
    'f4': 0, 'f6': 0, 'f8': 0, 'f10': 0, 'f16': 0, 'f18': 0,
}
...
def parse_ast(ast):
    ...
    if type(ast[0]) == int:
        ...
        # print('_______type(ast[0]) == tuple    TRUE')
        r = None
        instructions = []
        for inst in ast:
            # print("inst    ", inst)
            ...
            # print('___instructions ', instructions)
    ...
    if ast[0] == 'fun':
        ...
        if has_arg:
            ...
            if arg_cnt > 4:
                print('Too many arguments in function: ' + f_name)
        # print('f_stm ', f_stm)
